  ...
  return (
    <div className="min-h-screen bg-zinc-50 text-zinc-900">
      ...
      <div className="flex justify-center px-4 py-14 mt-20">
        <motion.div className="w-full max-w-3xl bg-white rounded-xl shadow-xl p-10">
          <div className="mb-10">
          ...
          <div className="mb-10">
            ...
            <div className="space-y-4">
              <input
                type="text"
                className="w-full rounded-xl border border-zinc-300 px-4 py-3 text-sm focus:outline-none
